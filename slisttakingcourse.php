...
<html>
    ...
    <body>
        <h4>Student List Taking Course</h4>
        <?php
        ...
        $query = "select s.studentname
                    from enrollment e, student s
                       where e.yearr='$yearr' and e.semester = '$semester' and e.courseCode = '$courseCode' and e.sssn = s.ssn;";
    ...
    <div class = "container col-6 justify-content-center mt-5">
        <table class="table table-sm table-hover table-dark table-striped caption-top border-primary">
            <caption>Student List Taking Course</caption>
            <tr>
