...
<html>
    ...
    <body>
        ...
        $ssn = $_GET['ssn'];
        $query = "Select C.*
                  From Student S Natural JOIN curriculacourses C
                  WHERE S.ssn = '$ssn' ";
    ...
    <div class = "container col-6 justify-content-center mt-5">
        <table class="table table-sm table-hover table-dark table-striped caption-top border-primary">
            <caption>My Curriculum</caption>
            <tr>
                <th class="table-primary">Curr Code</th>
                <th class="table-primary">Department Name</th>
