...
<html>
    ...
    <body>
        ...
        $ssn = $_GET['ssn'];
        $query = "SELECT examname,date,courseCode,yearr,semester
                    FROM examofsection 
                   WHERE issn = '$ssn'";
    ...
    <div class = "container col-6 justify-content-center mt-5">
        <table class="table table-sm table-hover table-dark table-striped caption-top border-primary">
            ...
            <tr>
                <th class="table-primary">ExamName</th>
                <th class="table-primary">Date</th>
                <th class="table-primary">CourseCode</th>
